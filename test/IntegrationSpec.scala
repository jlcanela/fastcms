...
class IntegrationSpec extends Specification {
 ...
 /*  "contain all operations defined in the website resource with api key" in {
    	running(TestServer(3333)) {
      	val json = Source.fromURL("http://localhost:3333/api-docs/website?api_key=special-key").mkString

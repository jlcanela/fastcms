  ...
  "API" should {
    ...
    "provite a websites_POST API" in {
      ...
      "create_uncompliant_json fails" in new CustomServer(DB_WEBSITES) {
        websites_POST("[]") must haveResult(msg = "create_valid", code = BAD_REQUEST, json = Json.parse("""{"status":"KO","message":{"obj.url":[{"msg":"error.path.missing","args":[]}],"obj.port":[{"msg":"error.path.missing","args":[]}],"obj.path":[{"msg":"error.path.missing","args":[]}],"obj.proxy":[{"msg":"error.path.missing","args":[]}],"obj.id":[{"msg":"error.path.missing","args":[]}],"obj.name":[{"msg":"error.path.missing","args":[]}]}}"""))
      }
    ...
    "provite a websites_PUT API" in {
      ...
      "create_uncompliant_json fails" in new CustomServer(DB_WEBSITES) {
        websites_PUT(0, "[]") must haveResult(msg = "update_valid", code = BAD_REQUEST, json = Json.parse("""{"status":"KO","message":{"obj.url":[{"msg":"error.path.missing","args":[]}],"obj.port":[{"msg":"error.path.missing","args":[]}],"obj.path":[{"msg":"error.path.missing","args":[]}],"obj.proxy":[{"msg":"error.path.missing","args":[]}],"obj.id":[{"msg":"error.path.missing","args":[]}],"obj.name":[{"msg":"error.path.missing","args":[]}]}}"""))
      }
    }
